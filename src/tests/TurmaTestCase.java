...
public class TurmaTestCase {
	...
	public void saveTurmaSuccess() {
		try {
			...
			bo.GerenciadorTurma.salvar(50, new Date(), new Date(), "Excel avançado", 1661903814, alunos);
		} 
		catch (Exception e) {
	...
	public void saveTurmaFail() throws Exception{
		GerenciadorTurma.salvar(0, new Date(), new Date(), "Excel avançado", 1661903814, null);
	}
	...
	public void saveTurmaLimiteQuantidadeFail() throws Exception{
		...
		bo.GerenciadorTurma.salvar(1, new Date(), new Date(), "Excel avançado", 1661903814, alunos);
	}
	
	
	@Test(expected=Exception.class)
	public void saveTurmaNegativeFail() throws Exception{
		GerenciadorTurma.salvar(-9, new Date(), new Date(), "Excel avançado", 1661903814, null);
	}
